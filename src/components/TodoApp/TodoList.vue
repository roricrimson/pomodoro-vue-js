  ...
  >
    ...
    >
      <div class="flex items-center gap-2">
        ...
        <button @click="clearError" class="ml-1 text-white hover:text-gray-200 flex-shrink-0">
    ...
    >
      ...
      <button class="w-6 aspect-square" type="submit" :disabled="isLoading">
        <div v-if="isLoading" class="animate-spin rounded-full h-5 w-5 border-2 border-[#828E80] border-t-transparent"></div>
